 ...
 */
public class Rolex extends JLabel implements MouseListener, ActionListener {
    ...
    public void mousePressed(MouseEvent evt) {
        if (running == false) {
            ...
            setText("Running: 0 secs");
            if(stTimer == null){
                stTimer = new Timer(100,this);
                stTimer.start();
            }else{
                stTimer.restart();
            }
    ...
    /**
     * Called when an event is received from the timer.
     */
