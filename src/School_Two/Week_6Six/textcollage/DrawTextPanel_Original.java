 ...
 *
 */
public class DrawTextPanel_Original extends JPanel {
    ...
    /**
     * Open a saved text Õle and read the background color as well as the text
     * strings.
     */
    private void openFile() {
        ...
        try {
            ...
            if (!in.nextLine().equals("New text collage Õle")) {
                JOptionPane.showMessageDialog(this, "Not a valid Õle \"" + openFile + "\".");
                return;
            }
        ...
        FileNotFoundException e) {
            JOptionPane.showMessageDialog(this, "Can't read the Õle \"" + openFile + "\".");
            System.out.println("Error message: " + e);
        }
    }
}